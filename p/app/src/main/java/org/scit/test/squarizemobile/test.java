...
import org.scit.test.squarizemobile.R;

import java.text.NumberFormat;
import java.util.ArrayList;

public class test extends FragmentActivity implements OnMapReadyCallback, GoogleMap.OnMarkerClickListener, GoogleMap.OnMapClickListener {
    ...
    private void setCustomMarkerView() {
        ...
        marker_root_view = LayoutInflater.from(this).inflate(R.layout.activity_test, null);
